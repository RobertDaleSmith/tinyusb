...
#include "ch32v30x.h"       // USBFSH register block, FunctionalState, RCC_*, SystemCoreClock
#include "ch32v30x_usb.h"   // USB_PID_*, USB_SETUP_REQ/PUSB_SETUP_REQ, USB_REQ_TYP_*, USBFS_UH_* bits

// Busy-loop delays (defined in hcd_ch32_usbfs_wch.c) — WCH's debug.h Delay_*
